    ...
    <div className='main'>
        ...
        <div className="main-container">
            {!showResult ? <><div className="greet">
                ...
                <div className="cards">
                    <div onClick={()=>setInput(cardText[0])} className="card">
                        <p>{cardText[0]}</p>
                        <img src={assets.compass_icon} alt="" />
                    </div>
                    <div onClick={()=>setInput(cardText[1])} className="card">
                        <p>{cardText[1]}</p>
                        <img src={assets.bulb_icon} alt="" />
                    </div>
                    <div className="card" onClick={()=>setInput(cardText[2])} >
                        <p>{cardText[2]}</p>
                        <img src={assets.message_icon} alt="" />
                    </div>
                    <div className="card" onClick={()=>setInput(cardText[3])} >
                        <p>{cardText[3]}</p>
            ...
            <div className="main-bottom">
                <div className="search-box">
                    ...
                    <div>
                        ...
                        {input? <img onClick={()=>onSent()} className='send-icon' src={assets.send_icon} alt="" /> : null }
